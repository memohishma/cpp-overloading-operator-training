...
if (particleName == "neutron") {
    ...
    G4String volName = aStep->GetPreStepPoint()->GetTouchable()->GetVolume()->GetName();
...
/////////////////////////////////////////////
        if (regionName == "physTarget") { //was the neutron detected in the target?
            ...
            man->FillNtupleDColumn(0, 1, preStepEnergy/keV);
            man->FillNtupleDColumn(0, 2, postStepEnergy/keV);
            ...
            man->FillNtupleDColumn(1, 1, preStepEnergy/keV);
            man->FillNtupleDColumn(1, 2, postStepEnergy/keV);
